...
export class UyelerComponent implements OnInit {
  ...
  UyeFiltrele(e: { target: { value: any; }; }) {
  ...
  Sil(kayit: Uye) {
    ...
    this.confirmdialogRef.componentInstance.dialogMesaj = kayit.uyeAdi + " " + kayit.uyeSoyadi + ' isimli kullanıcıyı silmek istiyor musunuz?';
